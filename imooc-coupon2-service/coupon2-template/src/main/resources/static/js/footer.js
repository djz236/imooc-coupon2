...
document.writeln("				<span>课程名称: Spring Cloud 实战企业级优惠券系统</span>");
document.writeln("				<span>作者: 李健</span>");
document.writeln("			</div>");
document.writeln("			<div id=\'rightContent\'>");
document.writeln("				<div id=\'footIcon\'>");
document.writeln("					<img id=\'logo\' src=\'/coupon-template/images/onepunch.jpg\' />");
document.writeln("				</div>");
document.writeln("");
document.writeln("			</div>");
